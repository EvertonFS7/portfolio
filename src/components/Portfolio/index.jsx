            ...
            <div className="section-portfolio">
                ...
                <div className="section-portfolio-card">
                    <div className="portfolio-card-content">
                        ...
                        <p className="card-description">Nesse sistema você pode adicionar os seus lucros e despesas e ter um melhor controle sobre a sua vida financeira.</p>
                ...
                <div className="section-portfolio-card">
                    <div className="portfolio-card-content">
                        ...
                        <p className="card-description">Refiz a página inicial do spotify e um dos meus primeiros projetos em que utilizei o Bootstrap.</p>
                ...
                <div className="section-portfolio-card">
                    <div className="portfolio-card-content">
                        ...
                        <p className="card-description">Nesse app você pode fazer o upload e exclusão de imagens. Nesse projeto utilizei react com typescript + firebase.</p>
